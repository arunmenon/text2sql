#!/usr/bin/env python3
"""
Table Context Generation CLI

Command-line interface for table context generation workflows.
"""
import argparse
import asyncio
import logging
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run table context generation workflow")
