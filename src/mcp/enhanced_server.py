"""
Enhanced MCP Server for Knowledge Graph

This module implements an enhanced MCP server that exposes Knowledge Graph
functionality with comprehensive operation documentation.
"""
import argparse
import logging
import os
...
def create_server(config: Dict[str, Any] = None) -> Server:
    ...
    # Create Enhanced Knowledge Graph resource
    kg_resource = EnhancedKnowledgeGraphResource(neo4j_client)
...
def main():
    """
    Run the enhanced MCP server as a standalone application.
    """
    parser = argparse.ArgumentParser(description="Enhanced Knowledge Graph MCP Server")
