...
-- Warehouses table
CREATE TABLE `project.dataset.Warehouses` (
...
CREATE TABLE `project.dataset.PurchaseOrders` (
...
CREATE TABLE `project.dataset.PurchaseOrderItems` (
...
CREATE TABLE `project.dataset.InventoryTransactions` (
...
CREATE TABLE `project.dataset.ShippingCarriers` (
...
-- ShipmentItems table
CREATE TABLE `project.dataset.ShipmentItems` (
